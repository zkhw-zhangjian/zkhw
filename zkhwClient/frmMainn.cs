...
namespace zkhwClient
{
    ...
    { 
        ...
        private void frmMainn_Load(object sender, EventArgs e)
        {
            ...
            dttv = grjddao.checkThresholdValues(Common._deviceModel, "");//获取阈值信息根据设备型号
            ...
            //默认打开人员登记界面
            personRegist frm = new personRegist();
            OpenWinToMain(frm);
        ...
        private void GetCreateInfo()
        {
            ...
            if (dts.Rows.Count > 0)
            {
                a = dts.Rows[0]["organ_name"].ToString();
                b = dts.Rows[0]["input_name"].ToString();
                c = dts.Rows[0]["zeren_doctor"].ToString();
            }
        ...
        {
            lbljddw.Text = "建档单位：" + a; //建档单位
            lbljdr.Text = "建档人：" + b;//建档人
            lblzrys.Text = "责任医生：" + c;//责任医生
        }
        #endregion
        ...
        private void InitLeft()
        {
            ...
            outlookBar.AddBand("公共卫生", iconPanel1);
            outlookBar.AddBand("系统设置", iconPanel2); 

            #region 公共卫生
            iconPanel1.AddIcon("人员登记", Image.FromFile(@"leftimg\rydj.png"), new EventHandler(PanelEventA));
            iconPanel1.AddIcon("体检进度", Image.FromFile(@"leftimg\tjjd.png"), new EventHandler(PanelEventA));
            iconPanel1.AddIcon("体检报告", Image.FromFile(@"leftimg\tjbg.png"), new EventHandler(PanelEventA));
            iconPanel1.AddIcon("个人基本信息建档", Image.FromFile(@"leftimg\grda.png"), new EventHandler(PanelEventA));
            iconPanel1.AddIcon("健康体检表", Image.FromFile(@"leftimg\jktjb.png"), new EventHandler(PanelEventA));
            iconPanel1.AddIcon("老年人生活自理能力评估", Image.FromFile(@"leftimg\lnjjkpg.png"), new EventHandler(PanelEventA));
            iconPanel1.AddIcon("老年人中医体质辨识", Image.FromFile(@"leftimg\lnrzy.png"), new EventHandler(PanelEventA));
            iconPanel1.AddIcon("健康扶贫", Image.FromFile(@"leftimg\jkfp.png"), new EventHandler(PanelEventA));
            iconPanel1.AddIcon("高血压患者服务", Image.FromFile(@"leftimg\gxy.png"), new EventHandler(PanelEventA));
            iconPanel1.AddIcon("2型糖尿病患者服务", Image.FromFile(@"leftimg\tnb.png"), new EventHandler(PanelEventA));
            iconPanel1.AddIcon("严重精神病障碍患者服务", Image.FromFile(@"leftimg\jsb.png"), new EventHandler(PanelEventA));
            iconPanel1.AddIcon("肺结核患者服务", Image.FromFile(@"leftimg\fjh.png"), new EventHandler(PanelEventA));
            iconPanel1.AddIcon("孕产妇健康服务", Image.FromFile(@"leftimg\ycf.png"), new EventHandler(PanelEventA));
            iconPanel1.AddIcon("0—6岁儿童健康服务", Image.FromFile(@"leftimg\rt.png"), new EventHandler(PanelEventA));
            iconPanel1.AddIcon("儿童中医健康服务", Image.FromFile(@"leftimg\rtzy.png"), new EventHandler(PanelEventA));
            #endregion

            #region 系统设置
            iconPanel2.AddIcon("基本设置", Image.FromFile(@"leftimg\jbsz.png"), new EventHandler(PanelEventB));
            iconPanel2.AddIcon("设备管理", Image.FromFile(@"leftimg\sbgl.png"), new EventHandler(PanelEventB));
            iconPanel2.AddIcon("系统日志", Image.FromFile(@"leftimg\xtsz.png"), new EventHandler(PanelEventB));
            iconPanel2.AddIcon("参数设置", Image.FromFile(@"leftimg\cssz.png"), new EventHandler(PanelEventB));
            iconPanel2.AddIcon("软件授权", Image.FromFile(@"leftimg\rjsq.png"), new EventHandler(PanelEventB));
            iconPanel2.AddIcon("生化血范围", Image.FromFile(@"leftimg\shxtfw.png"), new EventHandler(PanelEventB));
            #endregion
        ...
        #endregion
        private void frmMainn_FormClosed(object sender, FormClosedEventArgs e)
        {
            try
            {
                Environment.Exit(0);
        ...
        private void frmMainn_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        {
            lbldt.Text = "时间：" + DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss");
        }
        ...
        private Color lblbackcolor= Color.FromArgb(127, 190, 38);
        ...
        private void btnRydj_Click(object sender, EventArgs e)
        {
            personRegist frm = new personRegist();
            OpenWinToMain(frm);
        }

        private void btnTjjd_Click(object sender, EventArgs e)
        {
            examinatProgress frm = new examinatProgress();
            OpenWinToMain(frm);
        }

        private void btnTjBG_Click(object sender, EventArgs e)
        {
            examinatReport frm = new examinatReport();
            OpenWinToMain(frm);
        }

        private void btnJyqy_Click(object sender, EventArgs e)
        {
            HomeDoctorLogin frm = new HomeDoctorLogin();
            OpenWinToMain(frm);
        }
