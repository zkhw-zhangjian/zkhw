                ...
                if (arr_dt1.Rows.Count > 0)
                {
                    for (int j = 0; j < arr_dt1.Rows.Count; j++)
                    {
                        ...
                        if (arr_dt2.Rows.Count > 0)
                        {
                            ...
                            {
                                int flag = 1;
                                flag = Common.JudgeValueForSh(dttv, sh);
                ...
                if (arr_dt1 != null && arr_dt1.Rows.Count > 0)
                {
                    for (int j = 0; j < arr_dt1.Rows.Count; j++)
                    {
                        ...
                        if (arr_dt2.Rows.Count > 0)
                        {
                            ...
                            { 
                                int flag = 1;
                                flag = Common.JudgeValueForXCG(dttv, xcg);
                    ...
                    {//解析生化协议报文数据                   
                        ...
                        for (int i = 1; i < sHL7Lines.Length; i++)
                        {
                            ...
                            switch (sHL7Array[4])
                            {
                                ...
                                case "CK": sh.CK = sHL7Array[5].Substring(0, sHL7Array[5].IndexOf('.') + 3); break;
                                case "CKMB": sh.CKMB = sHL7Array[5].Substring(0, sHL7Array[5].IndexOf('.') + 3); break;
                                case "LDHL": sh.LDHL = sHL7Array[5].Substring(0, sHL7Array[5].IndexOf('.') + 3); break;
                                case "HBDH": sh.HBDH = sHL7Array[5].Substring(0, sHL7Array[5].IndexOf('.') + 3); break;
                                case "HCY": sh.HCY = sHL7Array[5].Substring(0, sHL7Array[5].IndexOf('.') + 3); break;
                                case "HBA1C": sh.HBA1C = sHL7Array[5].Substring(0, sHL7Array[5].IndexOf('.') + 3); break;
                                default: break;
                            }
                        }
                ...
                {//解析生化协议报文数据
                    ...
                    for (int i = 1; i < sHL7Lines.Length; i++)
                    {
                        ...
                        switch (sHL7Array[4])
                        {
                            ...
                            case "γ - GT": sh.GGT = sHL7Array[5]; break;
                            case "CK": sh.CK = sHL7Array[5]; break;
                            case "CK-MB": sh.CKMB = sHL7Array[5]; break;
                            case "LDH": sh.LDHL = sHL7Array[5]; break;
                            case "HBD": sh.HBDH = sHL7Array[5]; break; /*α - HBD - H 没有说明不具体知道对应名称*/
                            case "HCY-B": sh.HCY = sHL7Array[5]; break;
                            case "HBA1C": sh.HBA1C = sHL7Array[5]; break; //名称没找到
                ...
                {//解析生化协议报文数据
                    ...
                    for (int i = 1; i < sHL7Lines.Length; i++)
                    {
                        ...
                        switch (sHL7Array[3])
                        {
                            ...
                            case "GGT^1": sh.GGT = sHL7Array[4]; break;
                            case "CK^1": sh.CK = sHL7Array[4]; break;
                            case "CK-MB^1": sh.CKMB = sHL7Array[4]; break;
                            case "LDH^1": sh.LDHL = sHL7Array[4]; break;
                            case "HBDH^1": sh.HBDH = sHL7Array[4]; break;
                            case "HCY^1": sh.HCY = sHL7Array[4]; break;
                            case "HbA1c^1": sh.HBA1C = sHL7Array[4]; break;
                            default: break;
                        }
                    }
                    sh.createTime = DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss");
