        ...
        private void aUdiabetesPatientServices_Load(object sender, EventArgs e)
        {
            ...
            if (id != "")
            {
                ...
                if (dt != null && dt.Rows.Count > 0)
                {
                    ...
                    if (this.radioButton49.Tag.ToString() == dt.Rows[0]["fob"].ToString()) { this.radioButton49.Checked = true; this.textBox75.ForeColor = Color.Salmon; };
                    ...
                    if (this.radioButton47.Tag.ToString() == dt.Rows[0]["hb"].ToString()) { this.radioButton47.Checked = true; this.textBox63.ForeColor = Color.Salmon; };
                    this.textBox3.Text = dt.Rows[0]["sgft"].ToString();
                    string sgft = dt.Rows[0]["sgft"].ToString();
                    if (sgft != null && !"".Equals(sgft))
                    {
                        if (Convert.ToDouble(sgft) > 40) { this.textBox4.ForeColor = Color.Salmon; }
                    }
                    this.textBox6.Text = dt.Rows[0]["ast"].ToString();
                    string ast = dt.Rows[0]["ast"].ToString();
                    if (ast != null && !"".Equals(ast))
                    {
                        if (Convert.ToDouble(ast) > 40) { this.textBox8.ForeColor = Color.Salmon; }
                    }
                    this.textBox10.Text = dt.Rows[0]["albumin"].ToString();
                    string albumin = dt.Rows[0]["albumin"].ToString();
                    if (albumin != null && !"".Equals(albumin))
                    {
                        if (Convert.ToDouble(albumin) > 54 || Convert.ToDouble(albumin) < 34) { this.textBox11.ForeColor = Color.Salmon; }
                    }
                    ...
                    {
                        if (Convert.ToDouble(total_bilirubin) > 20 || Convert.ToDouble(total_bilirubin) < 2) { this.textBox66.ForeColor = Color.Salmon; }
                    }
                    ...
                    {
                        if (Convert.ToDouble(conjugated_bilirubin) > 6.8 || Convert.ToDouble(conjugated_bilirubin) < 1.7) { this.textBox69.ForeColor = Color.Salmon; }
                    }
                    this.textBox73.Text = dt.Rows[0]["scr"].ToString();
                    string scr = dt.Rows[0]["scr"].ToString();
                    if (scr != null && !"".Equals(scr))
                    {
                        if (Convert.ToDouble(scr) > 115 || Convert.ToDouble(scr) < 44) { this.textBox74.ForeColor = Color.Salmon; }
                    }
                    ...
                    {
                        if (Convert.ToDouble(blood_urea) > 8.2 || Convert.ToDouble(blood_urea) < 1.7) { this.textBox82.ForeColor = Color.Salmon; }
                    }
                    ...
                    {
                        if (Convert.ToDouble(tc) > 5.2) { this.textBox14.ForeColor = Color.Salmon; }
                    }
                    this.textBox16.Text = dt.Rows[0]["tg"].ToString();
                    string tg = dt.Rows[0]["tg"].ToString();
                    if (tg != null && !"".Equals(tg))
                    {
                        if (Convert.ToDouble(tg) > 1.7) { this.textBox17.ForeColor = Color.Salmon; }
                    }
                    this.textBox19.Text = dt.Rows[0]["ldl"].ToString();
                    string ldl = dt.Rows[0]["ldl"].ToString();
                    if (ldl != null && !"".Equals(ldl))
                    {
                        if (Convert.ToDouble(ldl) > 3.9 || Convert.ToDouble(ldl) < 1.5) { this.textBox20.ForeColor = Color.Salmon; }
                    }
                    this.textBox22.Text = dt.Rows[0]["hdl"].ToString();
                    string hdl = dt.Rows[0]["hdl"].ToString();
                    if (hdl != null && !"".Equals(hdl))
                    {
                        if (Convert.ToDouble(hdl) > 1.9 || Convert.ToDouble(hdl) < 0.9) { this.textBox23.ForeColor = Color.Salmon; }
                    }
                    ...
                    if (this.radioButton4.Tag.ToString() == dt.Rows[0]["ultrasound_abdomen"].ToString())
                    {
                        ...
                        this.textBox28.ForeColor = Color.Salmon;
                        ...
                        if (ctr is CheckBox)
                        {
                            ...
                            if (dt.Rows[0]["cerebrovascular_disease"].ToString().IndexOf(ck.Tag.ToString()) > -1)
                            {
                                ...
                                if ("23456".IndexOf(ck.Tag.ToString()) > -1) {
                                    this.textBox37.ForeColor = Color.Salmon;
                                }
                            }
                        }
                    }
                    ...
                    foreach (Control ctr in this.panel8.Controls)
                    {
                        ...
                        if (ctr is CheckBox)
                        {
                            ...
                            if (dt.Rows[0]["kidney_disease"].ToString().IndexOf(ck.Tag.ToString()) > -1)
                            {
                                ...
                                if ("23456".IndexOf(ck.Tag.ToString()) > -1)
                                {
                                    this.textBox39.ForeColor = Color.Salmon;
                                }
                            }
                        }
                    }
                    ...
                    foreach (Control ctr in this.panel9.Controls)
                    {
                        ...
                        if (ctr is CheckBox)
                        {
                            ...
                            if (dt.Rows[0]["heart_disease"].ToString().IndexOf(ck.Tag.ToString()) > -1)
                            {
                                ...
                                {
                                    this.textBox40.ForeColor = Color.Salmon;
                                }
                            }
                        }
                    }
                    ...
                    if (this.radioButton38.Tag.ToString() == dt.Rows[0]["nervous_system_disease"].ToString())
                    {
                        ...
                        this.textBox47.ForeColor = Color.Salmon;
                    };
                    ...
                    if (this.radioButton40.Tag.ToString() == dt.Rows[0]["other_disease"].ToString())
                    {
                        ...
                        this.textBox49.ForeColor = Color.Salmon;
                    };
                }
                //加载子表
