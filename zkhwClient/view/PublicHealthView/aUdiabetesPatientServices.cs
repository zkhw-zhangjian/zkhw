...
namespace zkhwClient.view.PublicHealthView
{
    public partial class aUdiabetesPatientServices : Form
    {
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            if (this.radioButton10.Checked == true) { diabetes_follow_recordBean.psychological_recovery = this.radioButton10.Tag.ToString(); };
            if (this.radioButton11.Checked == true) { diabetes_follow_recordBean.psychological_recovery = this.radioButton11.Tag.ToString(); };
            if (this.radioButton12.Checked == true) { diabetes_follow_recordBean.psychological_recovery = this.radioButton12.Tag.ToString(); };
            if (this.radioButton13.Checked == true) { diabetes_follow_recordBean.medical_compliance = this.radioButton13.Tag.ToString(); };
            if (this.radioButton14.Checked == true) { diabetes_follow_recordBean.medical_compliance = this.radioButton14.Tag.ToString(); };
            if (this.radioButton15.Checked == true) { diabetes_follow_recordBean.medical_compliance = this.radioButton15.Tag.ToString(); };
            ...
            diabetes_follow_recordBean.check_date = this.dateTimePicker3.Text;
            if (this.radioButton22.Checked == true) { diabetes_follow_recordBean.compliance = this.radioButton22.Tag.ToString(); };
            if (this.radioButton23.Checked == true) { diabetes_follow_recordBean.compliance = this.radioButton23.Tag.ToString(); };
            if (this.radioButton24.Checked == true) { diabetes_follow_recordBean.compliance = this.radioButton24.Tag.ToString(); };
            if (this.radioButton16.Checked == true) { diabetes_follow_recordBean.untoward_effect = this.radioButton16.Tag.ToString(); };
            if (this.radioButton17.Checked == true) { diabetes_follow_recordBean.untoward_effect = this.radioButton17.Tag.ToString(); };
            if (this.radioButton4.Checked == true) { diabetes_follow_recordBean.reactive_hypoglycemia = this.radioButton4.Tag.ToString(); };
            if (this.radioButton5.Checked == true) { diabetes_follow_recordBean.reactive_hypoglycemia = this.radioButton5.Tag.ToString(); };
            if (this.radioButton6.Checked == true) { diabetes_follow_recordBean.reactive_hypoglycemia = this.radioButton6.Tag.ToString(); };

            if (this.radioButton18.Checked == true) { diabetes_follow_recordBean.follow_type = this.radioButton18.Tag.ToString(); };
            if (this.radioButton19.Checked == true) { diabetes_follow_recordBean.follow_type = this.radioButton19.Tag.ToString(); };
            if (this.radioButton20.Checked == true) { diabetes_follow_recordBean.follow_type = this.radioButton20.Tag.ToString(); };
            if (this.radioButton21.Checked == true) { diabetes_follow_recordBean.follow_type = this.radioButton21.Tag.ToString(); };
            ...
            diabetes_follow_recordBean.next_visit_date = this.dateTimePicker2.Text;
