...
{
    public partial class checkXueya : Form
    {
        ...
        private void checkXueyaInfo_Load(object sender, EventArgs e)
        { 
            ...
            DataTable dtbichao = tjdao.checkXueyaInfo(dateTimePicker1.Value.ToString("yyyy-MM-dd HH:mm:ss"), null, basicInfoSettings.xcuncode);
            //DataTable dtbichao = tjdao.checkXueyaInfo(basicInfoSettings.createtime, null, basicInfoSettings.xcuncode);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            DataTable dtbichao = tjdao.checkXueyaInfo(time1, time2, null);
            if (dtbichao != null && dtbichao.Rows.Count > 0)
            {
