...
{
    public partial class checkXindt : Form
    {
        ...
        private void checkXindt_Load(object sender, EventArgs e)
        {
            //让默认的日期时间减一天
            this.dateTimePicker1.Value = this.dateTimePicker2.Value.AddDays(-1);
            this.button1.BackgroundImage = Image.FromFile(@str + "/images/check.png");

            DataTable dtbichao = tjdao.checkXdtInfo(dateTimePicker1.Value.ToString("yyyy-MM-dd HH:mm:ss"), null, basicInfoSettings.xcuncode);
            //DataTable dtbichao = tjdao.checkXdtInfo(basicInfoSettings.createtime, null, basicInfoSettings.xcuncode);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            DataTable dtbichao = tjdao.checkXdtInfo(time1, time2, null);
            if (dtbichao != null && dtbichao.Rows.Count > 0)
            {
