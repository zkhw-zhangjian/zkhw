...
{
    public partial class checkShenghua : Form
    {
        tjcheckDao tjdao = new tjcheckDao();
        string str = Application.StartupPath;//项目路径
        public checkShenghua()
        {
            InitializeComponent();
        }
        
        private void checkShenghua_Load(object sender, EventArgs e)
        {
            //让默认的日期时间减一天
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            DataTable dtbichao = tjdao.checkShenghuaInfo(time1, time2, null);
            if (dtbichao != null && dtbichao.Rows.Count > 0)
            {
