...
namespace zkhwClient
{
    ...
    public class Common
    {
        ...
        /// <returns></returns>
        public static bool GetPicThumbnail(string sFile, string dFile, int dHeight, int dWidth, int flag,out byte[] data)
        {
            System.Drawing.Image iSource = System.Drawing.Image.FromFile(sFile);
            ImageFormat tFormat = iSource.RawFormat;
            int sW = 0, sH = 0;
            if (dHeight == 0) dHeight = iSource.Height;
            if (dWidth == 0) dWidth = iSource.Width;
