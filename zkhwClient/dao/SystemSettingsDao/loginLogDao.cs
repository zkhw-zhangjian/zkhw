...
namespace zkhwClient.dao
{
    class loginLogDao
    {
        ...
        public bool HaveData(string id)
        {
            bool flag = false;
            string sql =string.Format("select count(id) from resident_base_info where id='{0}'",id);
